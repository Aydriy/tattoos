...
class Footer extends React.Component {
  render() {
    ...
    const SocialNetworks = (props) => {
      return (
        <ul className="social-network-ul-footer">
        ...
        <div className="container">
          <div className="nav-social">
            ...
            <div className="bottom-description">
              <div className="bottom-description-lable">
                <div className="bottom-description-p ">
                  <p>© Dream Masters Custom Tattoos Sweden, est. 2006</p>
                  <p>
                    228 Columbus Ave, San Francisco, CA 94133 | (415) 277-7204 |
                    info@dream-masters.com
                  </p>
                </div>
              </div>
              <div className="social-network-footer red-ell-nav">
